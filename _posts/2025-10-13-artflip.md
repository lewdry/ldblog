# ArtFlip: Serendipitous Discovery for Public-Domain Art

### What's an Artflip?
In my spare time, I’ve been building a site that surprises you with a different piece of art every time you visit. It’s called **Artflip**, and you can try it here: [https://artflip.me](https://artflip.me). You might be here because you've just been there. In that case, stay here, don't go back there. Phew.
...
### Why I Built Artflip
I had a vague 'is this possible' idea recently, which turned into a small obsession. *Is there an 'easy' (read, zero effort) way to discover public-domain art?* I've been trying to use public domain images in blogs and presentations on-and-off for the last few years, starting in around 2017. It's just a massive pain in the bum. My enthusiasm always dies pretty quickly. You need to:
...
Basically, you need a search strategy before you get started. There didn't appear to me, to be a truly random or 'serendipitous' way to be presented with **something good** and **something free to use**. 

The internet is full of vast collections of public-domain art which often go unnoticed. Museums like the **Metropolitan Museum of Art**, **the Rijksmuseum**, and the **the Art Institute of Chicago** have digitized millions of artworks between them. They've also waived copyright on high-resolution images, which is a generous, but surprisingly uncommon, move in the GLAM (Galleries, Libraries, Archives and Museums) world.

### How It Works: The Concept
Artflip pulls from a collection of over 5,000 highlighted public-domain artworks, from the Met, Rijksmuseum, and Art Institute of Chicago. Where possible, I've tried to pull artworks which have some marker of quality: those flagged 'highlights' or which are 'on display' in the museum. If either of those is true, then the artwork has passed some kind of curatorial benchmark.
...
Artflip looks pretty simple, and it is, but there are some smarts behind the scenes I'm quite proud of. I'm recording here, partly for my own record and partly for any nerds who want to know. Skip ahead if this isn't your thing.
...
Artflip checks for new highlighted artworks added to the Met, Rijksmuseum and Art Institute of Chicago weekly (every Friday night) and adds them to the Artflip collection automatically. It does this through three python scripts: Metfetch, Rijksfetch and Chicfetch, which run in GitHub Actions. 

Artflip also posts to Instagram twice a day (under the handle @artflip.me). Getting the Instagram/Meta API to work was 10x harder than all the museum API pulls combined. But now it's running it all ticks along nicely. I’ve made myself redundant, which is exciting.
...
### Where To From Here
On that cheerful note, I’m not entirely sure what’s next. Some ideas I’ve considered:

- Adding another museum's highlights to the collection (I'm looking at you, Smithsonian) 
- Tidying up the scripts and making something open source and re-usable
- Adding some kind of search function after all...
...
### Closing Thoughts
Artflip is easily the **best thing I’ve ever made**. I say that as a father of 2.5 children and someone who once deliberately dyed a baseball cap with turmeric.
