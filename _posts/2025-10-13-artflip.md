...
I relied on GitHub Copilot to **write my commit messages**, (for non-nerds reading this, a commit message is a technical note-to-self,or note-to-others if you have more friends than I do). In fact, I completely outsourced my commit messages, because I am lazy. I think this is the most exciting AI use case: automating drudgery, summarising a range of changes across a codebase into a human-readable short message. Here's a game. Below are two real commit messages from Artflip. 

Can you guess which was written by a diligent, tireless and detail-focused LLM, and which was written by me, a fallible, human man?
